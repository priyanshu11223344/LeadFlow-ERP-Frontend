    ...
    <header className="h-14 bg-white border-b border-gray-100 flex items-center justify-between px-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center justify-center">
          <div className="w-8 h-8 bg-slate-500 rounded-full flex items-center justify-center text-white text-[11px] font-bold uppercase shadow-sm cursor-pointer hover:opacity-90 transition-opacity">
            p
          </div>
        </div>
      </div>
